        ...
        <div class="burger-nav">
            <div class="burger-nav-items">
                ...
                <div class="burger-nav-item ">
                    ...
                    <a href="" class="burger-link">Кондитерские изделия</a>
                </div>
                <div class="burger-nav-item ">
                    <div>
                    ...
                    <a href="" class="burger-link">Выпечка</a>
                </div>
                <div class="burger-nav-item ">
                    <div>
                    ...
                    <a href="" class="burger-link">Корзина</a>
                </div>
            </div>
            <div class="products-separator"></div>
            <div class="burger-nav-items">
                <div>
                    <a href="" class="burger-link">Меню</a>
                </div>
                <div>
    
                    <a href="" class="burger-link">О компании</a>
                </div>
                <div>
    
                    <a href="" class="burger-link">Вакансии</a>
                </div>
                <div>
                    <a href="" class="burger-link">Доставка</a>
                </div>
            </div>
        </div>
    </div>
